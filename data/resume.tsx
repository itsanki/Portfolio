...
export const DATA = {
  ...
  summary:
    ...
    "Currently interning at ISI Kolkata, focusing on Machine Learning, Algorithms, AI, and LLMs. Completed a Summer School at IIIT Allahabad in Artificial Intelligence & Robotics. Winner of the Smart India Hackathon 2024 for developing TrailMine, a blockchain analytics platform. Former contractor for Scale AI subsidiaries, contributing to RLHF and model training for Fortune 500 companies",
    avatarUrl: "/me.png",
  skills: [
    "C++",
    "Python",
