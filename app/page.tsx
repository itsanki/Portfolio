...
const BLUR_FADE_DELAY_slow = 0.05;
              ...
              <div className="flex flex-col items-center justify-center space-y-4 text-center">
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                    ...
                    applications to Machine Learning projects and Data
                    Visualization. Here are a few of my favorites.
                  </p>
                </div>
              </div>
            </BlurFade>
            ...
            <BlurFade delay={BLUR_FADE_DELAY * 13}>
              <div className="flex flex-col items-center justify-center space-y-4 text-center">
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                    In my Sophomore year, I participated in a national-level hackathon that brought together students from over 2600 colleges across India. I have also gained valuable insights into Web3 and MLops. This experience has fueled my enthusiasm to continue pushing my technical boundaries in future.
                  </p>
                </div>
              </div>
            </BlurFade>
